// Named function
function named_add(x, y) {
    return x + y;
}
// Anonymous function
let anonymous_add = function (x, y) {
    return x + y;
};
/* Function type */
let another_add = function (x, y, z) {
    return x + y + z;
};
/*
...
*/
function concat_two_strings_opt_param(str1, str2) {
    if (str2) {
        return '${str1} ${str2}';
    }
    else {
...
*/
function concat_two_strings_default_param_1(str1, str2 = 'two') {
    return '${str1} ${str2}';
}
...
*/
function concat_strings(str, ...other_strings) {
    return "${str} ${other_strings.join('')}";
}
concat_strings('1', ...['2', '3', '4']);
let concat_strings_func_type = concat_strings;
/*
    Overloads
